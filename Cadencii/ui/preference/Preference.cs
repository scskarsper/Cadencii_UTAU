...
namespace cadencii
{
    ...
    partial class Preference : Form
    {
        ...
        private bool isSingersChanged = false;
        public bool isChangedUtauSingers()
        {
            return isSingersChanged;
        }
        ...
        private void comboResolControlCurve_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void chkVel_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void chkTranslateRoman_CheckedChanged(object sender, EventArgs e)
        {
