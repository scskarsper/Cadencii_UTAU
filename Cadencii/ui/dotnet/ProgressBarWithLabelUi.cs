...
namespace cadencii
{
    ...
    public class ProgressBarWithLabelUi : UserControl
    {
        ...
        private DateTime curDate=DateTime.Parse("1990-01-01");
        /// <summary>
        /// 必要なデザイナ変数です。
        /// </summary>
        ...
        public void setProgress(int value)
        {
            ...
            try
            {
                this.Invoke(new MethodInvoker(() =>
                {
                    ...
                    label1.Text = labeltext + " (" + ((int)(((value * 100.00) / progressBar1.Maximum))).ToString() + "%) consuming:" + ((int)ts.TotalSeconds).ToString() + "s";
                }));
            }
            catch { ;}
        }
