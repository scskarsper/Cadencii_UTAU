...
namespace cadencii.vsq
{
    ...
    {
        public string SplitDictionaryName = "Default";
        ...
        double renderStartClock = -1;

        [XmlIgnore]
        public double RenderStartClock
        {
            get { return renderStartClock; }
            set { renderStartClock = value; }
        }
        double renderEndClock = -1;

        [XmlIgnore]
        public double RenderEndClock
        {
            get { return renderEndClock; }
            set { renderEndClock = value; }
        }
        ...
        public VsqMetaText getMetaText()
        {
            return MetaText;
        }
        ...
        public int getEventIndex(int internal_id)
        {
            return MetaText.getEventList().findIndexFromID(internal_id);
        }

        public VsqEvent getEventByIndex(int index)
        {
            return MetaText.getEventList().Events[index];
        }

        public VsqEventList getEventList()
        {
            return MetaText.getEventList();
        }
