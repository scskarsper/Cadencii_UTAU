...
namespace cadencii.vsq
{
    ...
    public class UstEvent : ICloneable
    {
        ...
        private double splitLength = 12.5;
//        private double splitMaxLength = 60;
        private bool splitispercent = true;
        private float splitVoiceOverlap = 0;

        private int _MoreOver = 0;

        public int ReplaceNoteID = 0;
        ...
        public bool SplitisPercent
        {
            get
            {
                return splitispercent;
            }
            set
            {
                splitispercent = value;
            }
        }
        public float SplitVoiceOverlap
        {
            get
            {
                return splitVoiceOverlap;
            }
            set
            {
                splitVoiceOverlap = value;
            }
        }
        public float SplitSTP = 0;
        public float NotePreOverlap = 25;
        #endregion
